# pib_por_pais guide installation
...
To move beyond notebook prototyping, all reusable code should go into the `pib_por_pais/` folder package. To use that package inside your project, install the project's module in editable mode, so you can edit files in the `pib_por_pais` folder and use the modules inside your notebooks :
...
```python
from pib_por_pais.utils.paths import data_dir
data_dir()
```
